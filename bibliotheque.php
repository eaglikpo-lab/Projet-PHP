...
// Todo: Ajouter une méthode pour marquer un livre comme étant disponible/indisponible

class Book extends Library // Todo: Pourquoi l'héritage ?
{
    public string $title;
    ...
    public function __construct($title, $author, $year)
    {
        ...
        $this->author = $author;
        $this->year = $year;
        //$this-> available = $available; //TODO: Pourquoi c'est commenté ?
    }
...
class Library
{
    ...
    {
        //TODO: Retourner tous les livres dont le titre contient le terme de recherche
        foreach ($this->books as $book) {
            if ($book->title === $title) {
                return $book;
            }
    ...
    public function sauvegarder(
        $fichier
        /** TODO: l'argument $fichier n'est pas utilisé dans le corps de la fonction */
    ) {
